...
public class LeadArchonAttachment extends Attachment {
    ...
    public void doTurn() throws GameActionException {
        robot.getComms().setWatchtowerBuildLocation(getBestWatchtowerLocation());
        protMiners();
        updateStates();
        updateLeadAmounts();
    ...
    public MapLocation getBestWatchtowerLocation() throws GameActionException{
